...
const SectionHeading = ({ eyebrow, title, sub }: { eyebrow?: string; title: string; sub?: string }) => (
  <div className="max-w-3xl mx-auto text-center mb-10">
    {eyebrow && <p className="uppercase tracking-widest text-xs md:text-sm text-gray-200">{eyebrow}</p>}
    <h2 className="text-2xl md:text-4xl font-bold mt-1 text-white">{title}</h2>
    {sub && <p className="text-gray-200 mt-3 leading-relaxed">{sub}</p>}
  </div>
);
...
const Stat = ({ value, label }: { value: string; label: string }) => (
  <div className="text-center">
    ...
    <div className="text-gray-200 mt-1">{label}</div>
  </div>
);

const Feature = ({ icon: Icon, title, desc }: { icon: any; title: string; desc: string }) => (
  <Card className="rounded-2xl shadow-sm bg-white/10 border border-white/20">
    <CardContent className="p-6 text-white">
      <div className="flex items-start gap-4">
        <div className="p-3 rounded-xl bg-white/20"><Icon className="w-6 h-6" /></div>
        <div>
          <h4 className="font-semibold text-lg">{title}</h4>
          <p className="text-sm mt-1 leading-relaxed text-gray-200">{desc}</p>
        </div>
      </div>
    </CardContent>
  </Card>
...
const Tier = ({ name, price, tagline, items, cta }: { name: string; price: string; tagline: string; items: string[]; cta: string }) => (
  <Card className="rounded-2xl border-white/20 bg-white/10">
    <CardContent className="p-6 text-white">
      <div className="flex items-baseline justify-between">
        <h4 className="text-xl font-bold">{name}</h4>
        <div className="text-3xl font-extrabold">{price}<span className="text-base font-medium text-gray-300">/mo</span></div>
      </div>
      <p className="text-gray-200 mt-2 text-sm">{tagline}</p>
      <ul className="mt-4 space-y-2">
        {items.map((t, i) => (
          <li key={i} className="flex gap-2 text-sm text-gray-100"><CheckCircle2 className="w-4 h-4 mt-0.5" /> {t}</li>
        ))}
      </ul>
      <Button className="w-full mt-5 bg-white text-blue-700 hover:bg-gray-100">{cta}</Button>
    </CardContent>
  </Card>
);
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="uppercase tracking-widest text-xs text-blue-100">Cloud • Cybersecurity • IoT • Automation</p>
            <h1 className="text-3xl md:text-5xl font-extrabold mt-3 leading-tight">
              Secure, scalable cloud & IoT for the world’s <span className="bg-white text-blue-700 px-1 rounded">growing businesses</span>
            </h1>
            <p className="text-blue-100 mt-4 md:text-lg leading-relaxed">
              We help startups, SMEs, NGOs, schools, healthcare and finance teams migrate, secure, automate, and grow—globally.
            </p>
            <div className="mt-6 flex gap-3 flex-wrap">
              <Button className="bg-white text-blue-700 hover:bg-blue-50">Start a Free Assessment</Button>
              <Button variant="outline" className="border-white text-white hover:bg-white/10">Download Service Catalog</Button>
            </div>
            <div className="mt-6 grid grid-cols-3 gap-4">
              <Stat value="99.95%" label="Uptime targets" mutedClass="text-blue-100" />
              <Stat value=">=30%" label="Avg. cost savings" mutedClass="text-blue-100" />
              <Stat value="24/7" label="Security monitoring" mutedClass="text-blue-100" />
            </div>
          </motion.div>
      ...
      <section id="services" className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <SectionHeading
            ...
            sub="Start lean. Scale fast. Stay secure. Our bundles are designed for small teams up to global enterprises."
          />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6 space-y-3">
                ...
                <div className="pt-2">
                  <Button className="gap-2 bg-blue-600 hover:bg-blue-700">Get a Solution Plan <ArrowRight className="w-4 h-4"/></Button>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="packages" className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4">
          <SectionHeading eyebrow="Pricing" title="Simple packages that grow with you" sub="Transparent tiers; custom quotes for enterprises and regulated sectors worldwide." />
          <div className="grid md:grid-cols-3 gap-5">
            <Tier
              name="Starter"
              price="$199"
            ...
            <Tier
              ...
              price="Custom"
              tagline="For finance, healthcare, public sector, and global scale."
              items={[
      ...
      <section id="industries" className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <SectionHeading title="Where we make the biggest impact" sub="We focus on data‑sensitive and connected industries across the globe." />
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mt-2 text-sm">
                  Empower businesses and communities worldwide with secure, scalable, and affordable cloud solutions—protecting data while fueling growth.
                </p>
              </CardContent>
            </Card>
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mt-2 text-sm">
                  Become one of the world’s most trusted cloud‑cyber partners, delivering defense‑grade security to everyday organizations.
                </p>
              </CardContent>
            </Card>
            <Card className="rounded-2xl">
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                ...
                <ul className="mt-2 space-y-2 text-sm text-gray-700">
                  ...
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 mt-0.5"/> Global, remote‑first team</li>
                </ul>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4">
          <Card className="rounded-2xl bg-blue-700 text-white">
            <CardContent className="p-6 md:p-10 text-center">
              <h3 className="text-2xl md:text-3xl font-bold">Ready to secure, connect and automate?</h3>
              <p className="text-blue-100 mt-2">Book a free discovery call. We’ll map your quick wins and a 90‑day action plan.</p>
              <div className="mt-4">
                <Button className="gap-2 bg-white text-blue-700 hover:bg-blue-50">Book a Call <ArrowRight className="w-4 h-4"/></Button>
              </div>
            </CardContent>
          </Card>
        </div>
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                <form className="grid gap-4">
                  ...
                  <Button className="gap-2 bg-blue-600 hover:bg-blue-700">Send enquiry <Rocket className="w-4 h-4"/></Button>
                </form>
              </CardContent>
            </Card>
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3"><MapPin className="w-4 h-4"/> Global, remote‑first</div>
      ...
      <footer className="py-10 border-t">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-blue-600 text-white flex items-center justify-center"><Cloud className="w-4 h-4"/></div>
